    ...
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-4">
      ...
      <div className="flex gap-4 items-center">
        ...
        <motion.a
          ...
          className="w-16 h-16 btn-signature flex items-center justify-center text-white bg-[#25D366] shadow-2xl hover:bg-[#20ba59] transition-all duration-300 hover:scale-110 active:scale-95 cursor-pointer shadow-emerald-500/30 relative"
